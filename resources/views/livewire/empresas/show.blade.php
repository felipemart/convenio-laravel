        ...
        @if($empresa)
            <x-tabs wire:model="selectedTab">
                <x-tab name="users-tab" label="Informações" icon="o-users">
                    ...
                    <x-input readonly label="CNPJ" :value="$empresa->cnpj" class=""/>
                    <x-input readonly label="Nome Fantasia" :value="$empresa->nome_fantasia"/>
                    <x-input readonly label="Razao Social" :value="$empresa->razao_social" class=""/>
                    <x-input readonly label="Logradouro" :value="$empresa->logradouro" class=""/>
                    <x-input readonly label="Bairro" :value="$empresa->bairro" class=""/>
                    <x-input readonly label="CEP" :value="$empresa->cep" class=""/>
                    <x-input readonly label="UF" :value="$empresa->uf" class=""/>
                    <x-input readonly label="Cidade" :value="$empresa->cidade" class=""/>
                    <x-input readonly label="Email" :value="$empresa->email" class=""/>
                    ...
                    @if($empresa?->deleted_at)
                        <x-input readonly label="Data de exclusão"
                                 ...
                                 class=""/>
                        <x-input readonly label="Deletado por" :value="$empresa->deletedBy?->name" class=""/>
                    @endif
